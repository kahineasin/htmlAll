...
$pf.watermark = function (settings) {
    ...
    if ($pf.hasWatermark || parent.$pf.hasWatermark) {//以防iframe嵌套的功能出现多层水印(如查询网络图功能)
        return;
    }
    ...
    var doWaterMark = function () {
        ...
        if (defaultSettings.watermark_rows == 0 || (parseInt(defaultSettings.watermark_y + defaultSettings.watermark_height * defaultSettings.watermark_rows + defaultSettings.watermark_y_space * (defaultSettings.watermark_rows - 1)) > page_height)) {
            ...
            if (isNaN(defaultSettings.watermark_y_space)) { defaultSettings.watermark_y_space = 1;}//1行时,space是NaN --benjamin 20210422
        }
        var x;
        var y;
        if (oTemp != null) {
